...
function result() {
    ...
    if (customName.value !== "") {
        // STEP 10a: Create a new variable called name and set it equal to the value of the customName field
        var name = customName.value;
        // STEP 10b: Replace the name Bob in the story with the name variable
    ...
    if (document.getElementById("metric").checked) {
        ...
        newStory = newStory.replace("94 degrees Fahrenheit", temp + " degrees Celsius");
    }
